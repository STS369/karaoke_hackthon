    ...
    <div className="history-row">
      <div className="meta">
        ...
        <div className="dates">
          ...
          {item.updatedAt ? <span style={{marginLeft: 8}}>更新: {new Date(item.updatedAt).toLocaleString()}</span> : null}
        </div>
      </div>
      ...
      {!editing ? (
        <div className="fields">
          ...
          <div className="actions">
            ...
            <button className="btn danger" onClick={() => onDelete(item.id)}>削除</button>
          </div>
        </div>
      ) : (
        <div className="fields edit">
          ...
          <div className="actions">
            ...
            <button className="btn danger" onClick={() => onDelete(item.id)} style={{marginLeft: "auto"}}>削除</button>
          </div>
        </div>
      )}
    </div>
